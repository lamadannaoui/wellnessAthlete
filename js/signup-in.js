...
let changeForm = (e) => {  
	...
	aContainer.classList.toggle("is-txl");// he kermel t7ot aw tchile lcss (is-txl) 3and lcontainer te3it l signup
	bContainer.classList.toggle("is-txl");// mtl li fo2 bas hal mara lal container te3it l signin
